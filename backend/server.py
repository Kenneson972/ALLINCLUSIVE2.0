...
# ========== VILLA DATA - REMOVED ==========
# Les données des villas sont maintenant stockées uniquement en MongoDB
# Voir correction_villa_data.py pour l'intégration des 21 villas réelles du CSV
...
async def startup_db_client():
    ...
    try:
        ...
        # Vérifier le nombre de villas en base
